...
### Overview
This project demonstates website cloning combined with local DNS manipulation to simulate phishing and social engineering attacks in a controlled lab enviroment. The project highlights understanding attacker techniques and documenting defensive detection opportunities.

All activity was performed in isloated virtual machines for educational and defensive analysis purposes.
All websites used in this lab were created and hosted by the author solely for educational purposes.


### Lab Objectives
-  Clone a live website for offline hosting
